...
subclass of both \texttt{mls:Run} and \texttt{prov:Activity}, aligning with
ML-Schema's training lifecycle and PROV-O's activity-based provenance model.
$\TrainedModelC$ is a subclass of \texttt{mls:Model}. $\HyperparameterC$
extends \texttt{mls:HyperParameter} with physics-specific properties and
units, and $\ImplementationC$ extends \texttt{mls:Implementation}.
