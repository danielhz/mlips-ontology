...
\begin{align}
  \MLIPAlgorithmC &\sqsub \existsR{hasHyperparameter}{Hyperparameter} \axiomtag
\end{align}
...
\begin{align}
  \MLIPAlgorithmC &\sqsub \existsR{supportsSimulation}{SimulationType} \axiomtag
\end{align}
...
\begin{align}
  \TrainingRunC &\sqsub \exactR{1}{executes}{MLIPAlgorithm} \axiomtag
\end{align}
...
\begin{align}
  \TrainingRunC &\sqsub \exactR{1}{runsOn}{TrainingDataset} \axiomtag
\end{align}
...
\begin{align}
  \TrainingRunC &\sqsub \exactR{1}{produces}{TrainedModel} \axiomtag
\end{align}
...
\begin{align}
  \TrainedModelC &\sqsub \existsR{produces^{-}}{TrainingRun} \axiomtag
\end{align}
...
\begin{align}
  \HyperparameterC &\sqsub \existsR{hasHyperparameter^{-}}{MLIPAlgorithm} \axiomtag
\end{align}
...
\begin{align}
  \ImplementationC &\sqsub \existsR{hasImplementation^{-}}{MLIPAlgorithm} \axiomtag
\end{align}
...
\begin{align}
  \trainedWithR &\equiv \producesR^{-} \circ \executesR \axiomtag
\end{align}
...
\begin{align}
  \existsR{hasHyperparameter}{\top} &\sqsub \MLIPAlgorithmC \axiomtag \\
  \existsR{hasImplementation}{\top} &\sqsub \MLIPAlgorithmC \axiomtag \\
  \existsR{supportsSimulation}{\top} &\sqsub \MLIPAlgorithmC \axiomtag
\end{align}
