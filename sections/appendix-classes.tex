...
\paragraph{Outgoing properties.} $\dlRole{appliesMethod}$, $\dlRole{hasTrainingRun}$, $\dlRole{produces}$, $\dlRole{runsOn}$, $\dlRole{trainingDuration}$, $\dlRole{trainingHardware}$, $\dlRole{peakMemory}$, $\dlRole{gpuHours}$.
...
\paragraph{Outgoing properties.} $\dlRole{evaluatesModel}$, $\dlRole{hasAccuracyMetric}$, $\dlRole{hasHyperparameterSetting}$, $\dlRole{reportedIn}$, $\dlRole{targetMaterial}$, $\dlRole{usesAlgorithm}$, $\dlRole{usesTrainingData}$, $\dlRole{inferenceTimePerAtom}$, $\dlRole{inferenceHardware}$.
