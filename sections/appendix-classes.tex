...
This appendix describes all 27 classes defined in the \MLIPsOntology{}.
...
\paragraph{Outgoing properties.} $\dlRole{coversMaterial}$, $\dlRole{coversProperty}$, $\dlRole{datasetProvenance}$, $\dlRole{hasConfiguration}$, $\dlRole{hasDFTCalculation}$, $\dlRole{samplingStrategy}$, $\dlRole{numConfigurations}$.
