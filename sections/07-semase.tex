...
The \SemASE{} ontology complements the \MLIPsOntology{}:
\texttt{semase:Atomic\-System} corresponds to atomic configurations
that populate a $\TrainingDatasetC$, and \texttt{semase:Calculator}
can be linked to an $\ImplementationC$.
