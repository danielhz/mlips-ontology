...
Figure~\ref{fig:ontology-overview} provides an overview. The ontology uses
the namespace \texttt{\mlipsns} (prefix \mlipsprefix{});
Table~\ref{tab:prefixes} lists the external prefixes used. In the following,
we omit the \mlipsprefix{} prefix for concepts and properties of the
\MLIPsOntology{}.
...
Figure~\ref{fig:training-data-detail} shows the full class diagram for this
module.
...
\begin{figure}[t]
\centering
%% TODO: create detailed Training Data module class diagram
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}%
  Training Data module detail diagram (to be created)%
  \vspace{2cm}}}
\caption{Detailed view of the Training Data module, showing the full class
  hierarchy including $\DFTCalculationC$, $\DFTSettingsC$,
  $\MaterialSystemC$, $\AtomicConfigurationC$, and their relationships.}
\label{fig:training-data-detail}
\end{figure}
...
Figure~\ref{fig:benchmark-detail} shows the full class diagram for this
module.
...
\begin{figure}[t]
\centering
%% TODO: create detailed Benchmark module class diagram
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}%
  Benchmark module detail diagram (to be created)%
  \vspace{2cm}}}
\caption{Detailed view of the Benchmark module, showing the full class
  hierarchy including $\BenchmarkStudyC$, $\BenchmarkResultC$,
  $\AccuracyMetricC$, $\MetricTypeC$, $\MetricPropertyC$, and their
  relationships to $\TrainedModelC$ and $\MaterialSystemC$.}
\label{fig:benchmark-detail}
\end{figure}
