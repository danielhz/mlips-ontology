...
For a given material and target property, which algorithm--model
combinations perform best? This analytical query ranks models by
accuracy, enabling systematic comparison across the literature:
%
\begin{lstlisting}[language=sparql]
