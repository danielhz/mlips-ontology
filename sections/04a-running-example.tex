...
for each neighbor $j$ within $\Rcut$: the atomic type $z_j$ and
the relative position vector $\mathbf{r}_{ij} = \mathbf{r}_j -
\mathbf{r}_i$. Crucially, atoms beyond $\Rcut$ do not
...
$\HyperparameterC$ instances ($\Rcut$, $\Rmin$, $N_Q$,
...
$\levmax = 16$, and $N_Q = 8$. These concrete
