...
%% Per-paper subsections live as fragments under sections/catalogue/.
%% Order: foundational HDNNP/GAP/MTP/ACE/ANI papers, then descriptor/
%% network/equivariant families, then universal/foundation models, then
%% applied multicomponent and software-tooling entries. The DeepMD-kit
%% entry (wang2018dpkit) is included as a software paper that exercises
%% the ontology's Library/Implementation/version coverage.

\input{sections/catalogue/behler2007}
\input{sections/catalogue/bartok2010}
\input{sections/catalogue/shapeev2016}
\input{sections/catalogue/smith2017}
\input{sections/catalogue/schutt2018}
\input{sections/catalogue/bartok2018si}
\input{sections/catalogue/wang2018dpkit}
\input{sections/catalogue/lysogorskiy2021ace}
\input{sections/catalogue/smith2019ccx}
\input{sections/catalogue/eckhoff2021spin}
\input{sections/catalogue/batatia2022}
\input{sections/catalogue/batzner2022}
\input{sections/catalogue/chen2022}
\input{sections/catalogue/deng2023}
\input{sections/catalogue/gubaev2023}
\input{sections/catalogue/musaelian2023allegro}
\input{sections/catalogue/qi2023}
\input{sections/catalogue/batatia2024mp0}
\input{sections/catalogue/nitol2024nial}
