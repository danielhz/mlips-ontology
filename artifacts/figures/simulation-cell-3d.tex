...
% Axis labels
\node[font=\footnotesize, gray!70!black] at (\L+0.3,0,0) {$a$};
\node[font=\footnotesize, gray!70!black] at (0,\L+0.3,0) {$b$};
\node[font=\footnotesize, gray!70!black] at (0,0,\L+0.3) {$c$};
...
% Legend
\node[ti, minimum size=5pt] at (\L+1.0,\L-0.5,\L) {};
\node[font=\scriptsize, anchor=west] at (\L+1.3,\L-0.5,\L) {Ti};
\node[al, minimum size=5pt] at (\L+1.0,\L-1.2,\L) {};
\node[font=\scriptsize, anchor=west] at (\L+1.3,\L-1.2,\L) {Al};
